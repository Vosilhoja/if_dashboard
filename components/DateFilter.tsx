...
import { Calendar, ChevronLeft, ChevronRight, CalendarDays, SlidersHorizontal } from 'lucide-react';
...
export const DateFilter: React.FC<DateFilterProps> = ({
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-800 p-3 lg:p-4 rounded-2xl flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 shadow-xl">
      {/* Mode toggler */}
