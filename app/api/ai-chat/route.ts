...
4. ТОНАЛЬНОСТЬ И ФОРМАТ:
Отвечай профессионально, структурированно, без воды, используя жирный шрифт для ключевых цифр, маркированные списки и чёткие рекомендации. Пиши на чистом русском языке.`;
